...
#filename = "C:\Users\gursa\OneDrive\Documents\Second Year\Astro 205\Homework\Problem set 3"
#filename += "vedit.txt"
...
PhotometricData = np.loadtxt("vedit.txt", comments="#")
VelocityData = np.loadtxt("vel.txt", comments="#")
###############################################################################
...
Distance2 = -(0.2225-0.224425)*period*86400
...
RADStar1 = (Distance1*VELStar1)/2
RADStar2 = (Distance2*VELStar2)/2
